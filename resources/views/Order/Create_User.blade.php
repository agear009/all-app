          ...
          <div class="page-inner">
            ...
            >
              ...
              <div class="ms-md-auto py-2 py-md-0">
                ...
                <a href="{{ route('order_user.') }}" class="btn btn-primary btn-round">Tambah Order</a>
              </div>
            </div>
            <div class="row">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row" colspan="6">
                                ...
                                <input type="text" class="form-control" id="name" name="jumlah" aria-describedby="name Category" required>
                                <input type="text" class="form-control" id="name" name="keterangan" aria-describedby="name Category" value="Baru memesan" required>
                                <input type="text" class="form-control" id="name" name="status" aria-describedby="name Category" value="Menunggu Pembayaran" required>
