      ...
      <div class="container px-vw-5 py-vh-5">
        <div class="row d-flex align-items-center">
          ...
          <div class="col-12 col-lg-5 bg-dark rounded-5 py-5" data-aos="fade">
            ...
            <h2 class="display-4">Kami menyediakan akun Youtube yang sudah monetisasi dan telah menghasilkan cuan<br>
        ...
        <div class="row d-flex gx-5 align-items-center">
          <div class="col-12 col-lg-6">
            <div class="rounded-5 bg-black p-5 shadow" data-aos="zoom-in-right">
              ...
              <p class="text-secondary lead">{!! $Post->content !!}</p>
              <div class="d-flex justify-content-start align-items-center border-top border-secondary pt-3">
                <img src="{{ asset('storage/Post/'.$Post->image) }}" width="96" height="96" class="rounded-circle me-3" alt="a nice person"
                  data-aos="fade" loading="lazy">
                <div>
                  <span class="h6 fw-5">{{ $Post->author }}</span><br>
                  <small class="text-secondary">PT Saamparan Digital Group</small>
                </div>
              </div>
            </div>
          ...
          <div class="col-12 col-lg-6">
            <div class="p-5 pt-0" data-aos="fade">
              <span class="h5 text-secondary fw-lighter">{{ $Post->id_category }}</span>
