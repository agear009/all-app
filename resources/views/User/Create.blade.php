                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row" colspan="6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="email" aria-describedby="name Category" required>
                            ...
                            <tr>
                              ...
                              <tr>
                                ...
                                <input type="file" class="form-control" id="name" name="ktp" aria-describedby="Cover" required>
                              ...
                              <tr>
                                ...
                                <input type="text" class="form-control" id="name" name="nohp" aria-describedby="Cover" required>
                              ...
                              <tr>
                                ...
                                <label for="exampleInputname1" class="form-label">Level</label>
                                    ...
                                    <option class="form-control" id="level_user" name="level" value=""></option>
                              ...
                              <tr>
                                ...
                                <input type="text" class="form-control" id="name" name="id_transaksi" aria-describedby="Cover" required>
                                </th>
                              </tr>
                              ...
                              <tr>
                                ...
                                <input type="text" class="form-control" id="name" name="norek" aria-describedby="Cover" required>
                                </th>
                              </tr>
                              ...
                              <tr>
                                ...
                                <input type="text" class="form-control" id="rupiah" name="saldo" aria-describedby="Cover" required>
                                </th>
                              </tr>
